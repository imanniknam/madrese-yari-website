...
export function NeedCard({ need }: { need: Need }) {
  ...
  return (
    <Link
      href={`/needs/${need.id}`}
      className="group flex flex-col gap-4 rounded-card border border-brand-100 bg-white p-5 shadow-[0_10px_30px_-18px_rgba(16,44,31,0.35)] transition-transform hover:-translate-y-1"
    >
